...
sizes, weights = get_size_dists_from_beta_dist(a=0.5, b=0.5)
...
for run_id in range(n_runs):
    for beta in betas:
        ...
        output_path = '../Results/Simulations/HONG_2words_HomMix_synth_bimodal/%s/fixed_p%.2f_varbeta_run%i/'%(rule, p, run_id)
